...
- **Что делаем:** SceneMap — карта мест из твоих любимых фильмов: выбираешь фильмы → пины локаций съёмок → карточка «кадр тогда / место сейчас» → пеший маршрут «кино-прогулка».
