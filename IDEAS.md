...
> **Про слово «судья».** Судья = член **жюри** хакатона (тот, кто оценивает проекты и выбирает победителей); ему показываем демо. Формулировки вроде «судья снимает свой рюкзак» — это **приём для показа**: во время демо даёшь приложение в руки живому человеку (члену жюри или любому из зала), и он пробует его на своём — фоткает свой рюкзак, рисует форму на whiteboard-доске, отвечает голосом. Вау рождается из реального, незаготовленного ввода прямо в зале. Работать всё должно и на обычном примере — «живой ввод» это просто эффектный способ показать.
...
- **Демо за 2 минуты:** судья снимает свой рюкзак прямо в зале → через 5 сек карточка «Osprey Daylite, б/у отлично, $40–55, потому что…» → жмёт Post → карточка влетает в живую ленту на большом экране.
- **Почему выигрышно:** демо строится на предмете самого судьи — магия из его рук. One-shot конвейер, а не чат: ноль риска зависнуть в диалоге, готовый шареабельный артефакт с ценовым ризонингом.
...
- **Демо за 2 минуты:** судья вслух даёт неверный ответ → ИИ _перебивает на полуслове_ и наводящим вопросом выводит на правильный → в конце устный вердикт. Голос, реалтайм, живой препод.
...
- **Демо за 2 минуты:** судья пишет хитрый заход → экран вспыхивает GRANTED → его имя влетает на лидерборд комнаты → уровень 2. После этого каждый хочет попробовать сам.
...
- **Демо за 2 минуты:** судья рисует на доске пару блоков и кнопку, снимает на телефон → через ~15 сек на экране рабочая форма, которую можно тыкать.
- **Почему выигрышно:** vision + codegen в одном жесте, использует то, что физически есть в зале (досок на хакатоне полно), магия из рисунка самого судьи.
...
- **Фаворит панели — SnapSell.** Единственная, где вау рождается из вещи в руках судьи, демо-путь линеен и почти не может сломаться (один vision-вызов → карточка → Post), результат — красивый шареабельный артефакт с ценовым обоснованием. Идеально на четверых за 7 часов.
- **Самое «в тему OpenAI» — Codex Colosseum и Napkin** (Developer tools, судьи-разработчики их любят).
